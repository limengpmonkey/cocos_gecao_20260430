    ...
    return [
        {
            ...
            pressureCurve: [
                { timeSec: 0, normalHpMul: 0.85, normalSpeedMul: 0.80, spawnRateMul: 0.62, maxAliveMul: 0.52, pressureIndex: 0.58 },
                { timeSec: 30, normalHpMul: 0.95, normalSpeedMul: 0.86, spawnRateMul: 0.80, maxAliveMul: 0.66, pressureIndex: 0.78 },
                { timeSec: 70, normalHpMul: 1.10, normalSpeedMul: 0.98, spawnRateMul: 1.18, maxAliveMul: 1.05, pressureIndex: 1.02 },
                { timeSec: 110, normalHpMul: 1.26, normalSpeedMul: 1.08, spawnRateMul: 1.42, maxAliveMul: 1.22, pressureIndex: 1.26 },
                { timeSec: 150, normalHpMul: 1.46, normalSpeedMul: 1.15, spawnRateMul: 1.70, maxAliveMul: 1.40, pressureIndex: 1.55 },
                { timeSec: 180, normalHpMul: 1.34, normalSpeedMul: 1.10, spawnRateMul: 1.50, maxAliveMul: 1.30, pressureIndex: 1.36 },
            ],
            elite: {
                enabled: true,
                startTimeSec: 75,
